    ...
    return (
      <Html lang="en">
        <Head>
          ...
          <meta
            name="description"
            content="Venice is your financial database. Continuously sync data from over 12,000 financial institutions & multiple data providers in minutes, saving yourself hours of manual input & expensive copy/paste mistakes."
          />
          ...
          <meta
            ...
            content="Venice is the open-source data infrastructure trusted by data analysts, personal finance geeks, and developers to unify & access their finances in the most powerful & flexible ways."
          />
